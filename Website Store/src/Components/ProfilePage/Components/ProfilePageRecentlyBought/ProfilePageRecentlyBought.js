...
import "./ProfilePageRecentlyBought.css"
import {ProfileTopProducts} from "../../../../Data"
import { Link } from "react-router-dom";

function ProfilePageRecentlyBought() {
  return (
    <div className="ProfilePageTopProductsContainer">
        <div className="ProfilePageTopProductsContainerHeader">Recently Bought</div>
        <hr />
        <div className="ProfilePageTopProductsContainerImages">
            {ProfileTopProducts.map((image)=>{
                        return (
                            <>
...
export default ProfilePageRecentlyBought