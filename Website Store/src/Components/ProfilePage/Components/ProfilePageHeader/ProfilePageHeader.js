...
function ProfilePageHeader({ profileView }) {
  ...
  return (
    <div className="ProfilePageHeaderMain">
      <div className="ProfilePageHeaderMainTopContainer">
        <span></span>
      </div>
      <div className="ProfileDetails">
        ...
        <div className="ProfileNumbers">
          <div className="ProfileDetailsPostsCount">
            ...
            <div className="ProfileDetailsPostsCountNumber">
              {ProfileData[0].postsCount}
            </div>
          </div>
          <div className="ProfileDetailsFollowersCount">
            <div className="ProfileDetailsFollowersCountHeader">Followers</div>
            <div className="ProfileDetailsFollowersCountNumber">
              {ProfileData[0].followersCount}
            </div>
          </div>
        </div>
        <div className="ProfileControlButtons">
          ...
          <button id="messageBtn">
            <div className="ProfileExtraDetailsControlsContainer">
        ...
        <div className="ProfileExtraInfo">
          ...
          <div className="ProfileAboutHeader">
            ...
            <div className="ProfileAbout">
              {ProfileData[0].about.substring(0, 150)}{" "}
              <button>
                <b>{"Read More..."}</b>
              </button>
            </div>
      ...
      <div className="ImageGrid">
        {profileView && (
          <div className="ImageGridControlsBar">
            <button
              id="postsImageBtn"
              onClick={() => setImageGridView("posts")}
            >
              Posts
            </button>
            <button
              id="rewardsImagesBtn"
              onClick={() => setImageGridView("rewards")}
            >
              Rewards
            </button>
          </div>
                      ...
                      <>
                        <div className="rewardImagePopup" key={image.id}>
                          ...
                          <div className="rewardImagePopupContent">
                            <img
                              id="rewardImagePopupImg"
                              src={require("./" + image.src)}
                              alt={image.alt}
                              height="400px"
                            />
                            <div className="rewardImagePopupContentMain">
                              <div id="rewardImagePopupContentMainName">
                                {image.storeName}:
                              </div>
                              <div id="rewardImagePopupContentMainAddr">
                                {image.storeAddr}
                              </div>
                              <div id="rewardImagePopupContentMainExpiry">
                                <img
                                  src={require("./redAlert.png")}
                                  alt="red info icon"
                                />
                                <div id="rewardImagePopupContentMainExpiryDateContainer">
                                  <div id="rewardImagePopupContentMainExpiryDateContainerMessage">
                                    Offer Expiry Date
                                  </div>
                                  <div id="rewardImagePopupContentMainExpiryDate">
                                    {image.offerExpiry}
                                  </div>
                                </div>
                              </div>
                              <div className="rewardImagePopupContentMainBody">
                                Keep shopping from the same shop to keep
                                progressing and keep getting more exciting
                                offers with your shopping.
                              </div>
                              <button id="giftReward">
                                Gift this to your friend
                              </button>
                              <div>
                                <button id="giftOffer">Apply this offer</button>
                              </div>
                            </div>
                          </div>
                        </div>
