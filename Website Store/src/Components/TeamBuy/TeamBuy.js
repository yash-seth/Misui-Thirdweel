        ...
        <div className='TeamBuyHomepageContainer'>
            ...
            <div className='TeamBuyBanners'>
                {TeamBuyData.map((TeamBuyProduct)=>{
                    return <Link to="/teamBuyItemSearch" style={{textDecoration: "none"}}><img id="TeamBuyBanner" key={TeamBuyProduct.id} src={require("./"+TeamBuyProduct.src)} alt={TeamBuyProduct.alt} height="200px"/></Link>
                })}
            </div>
        </div>
      )
