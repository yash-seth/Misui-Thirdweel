...
import "./StoreProfilePageTopProducts.css"
import {storeProfileTopProducts} from "../../../../Data"
import { Link } from "react-router-dom";

function StoreProfilePageTopProducts() {
  return (
    <div className="StoreProfilePageTopProductsContainer">
        <div className="StoreProfilePageTopProductsContainerHeader">Top Products</div>
        <hr />
        <div className="StoreProfilePageTopProductsContainerImages">
...
export default StoreProfilePageTopProducts