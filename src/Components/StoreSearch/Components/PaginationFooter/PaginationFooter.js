...
function PaginationFooter() {
  return (
    <div className='PaginationFooterContainer'>
        <button style={{textDecoration: "none"}}><img id="left_arrow" src={require("./left-arrow.png")} alt="left arrow" height="30px"/></button>
        ...
        <button style={{textDecoration: "none"}}><img  id="right_arrow" src={require("./right-arrow.png")} alt="right arrow" height="30px"/></button>
    </div>
  )
}
